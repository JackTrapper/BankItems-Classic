...
L["Void Storage data not found. Please visit the Void Storage NPC on this character once to record it."] = "Данные Хранилища Бездны не найдены. Пожалуйста посетите Смотрителя Хранилища этим персонажем для записи этих данных." -- Needs review
